...
import { BOXPIC1, BOXPIC2 } from "@/constants";
            ...
            >
              <Tab.Pane eventKey={"Mission"}>
                <div className="content">
                  <p>
                    We are an independent gym that is committed to working with
                    you to gain the results you want. Whether your aim is to
                    loose weight, tone up, build bulk or gain weight we can put
                    together a gym programme or recommend.
                  </p>
                </div>
              </Tab.Pane>
              <Tab.Pane eventKey={"Vision"}>
                <div className="content">
                  <p>
                    ...
                    bibendum ultrices. Pellentesque non feugiat nisi. Nam
                    aliquam accumsan ante, ut accumsan risus together.
                  </p>
                </div>
              </Tab.Pane>
            </Tab.Content>
